						...
						?>
							...
							<?php 
								...
								if($img == "/path/to/default.png"){
									...
									echo '<a rel="nofollow" class="share-facebook sd-button share-icon no-text" href="';
									echo the_permalink();
									echo '?share=facebook&amp;nb=1" title="Share on Facebook" id="sharing-facebook-9333">';
									echo '</a></li>';
									echo '<li class="share-linkedin">';
									echo '<a rel="nofollow" class="share-linkedin sd-button share-icon no-text" href="';
									echo the_permalink();
									echo '?share=linkedin&amp;nb=1" title="Click to share on LinkedIn" id="sharing-linkedin-9333">';
									echo '</a></li>';
									echo '<li class="share-twitter">';
									echo '<a rel="nofollow" class="share-twitter sd-button share-icon no-text" href="';
									echo the_permalink();
									echo '?share=twitter&amp;nb=1" title="Click to share on Twitter" id="sharing-twitter-9333">';
									echo '</a></li>';
									echo '<li class="share-google-plus-1"><a rel="nofollow" class="share-google-plus-1 sd-button share-icon no-text" href="';
									echo the_permalink();
									echo '?share=google-plus-1&amp;nb=1" title="Click to share on Google+" id="sharing-google-9333">';
									echo '</a></li>';
									echo '<li class="share-pinterest">';
									echo '<a rel="nofollow" class="share-pinterest sd-button share-icon no-text" href="';
									echo the_permalink();
